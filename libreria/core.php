...
define ("RUTA_XMLPage", RUTA_BASE."XMLPage/");
define ("RUTA_BEANS", RUTA_BASE."Beans/");
define ("RUTA_Mpdf", RUTA_BASE."mpdf/");
define ("RUTA_PHPMail", RUTA_BASE."PHPMailer/");
define ("RUTA_PHP_vendor", RUTA_BASE."vendor/");
define ("RUTA_Get_Set", RUTA_BASE."get_set/");
